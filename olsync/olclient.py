...
class OverleafClient(object):
    ...
    def __init__(self, cookie=None, csrf=None, ce_url=None):
        ...
        self._FOLDER_URL = self._BASE_URL + \
            "/project/{}/folder"  # The URL to create folders
        self._COMPILE_URL = self._BASE_URL + \
            "/project/{}/compile?enable_pdf_caching=true"  # The URL to compile the project
...
=======
>>>>>>> parent of e874d3d (fix csrfToken)
        r = reqs.post(self._UPLOAD_URL.format(project_id),
...
=======
>>>>>>> parent of e874d3d (fix csrfToken)
        r = reqs.post(self._COMPILE_URL.format(project_id),
...
=======
>>>>>>> parent of e874d3d (fix csrfToken)
            self._BASE_URL + pdf_file['url'], cookies=self._cookie, headers=headers)
